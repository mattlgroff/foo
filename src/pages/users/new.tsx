import { userMetadata as modelMetadata, UserMetadata } from '@/db/models/user';
...
const NewUserPage = () => {
    ...
    async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (response.ok) {
            ...
            alert(`There was a problem creating your user. ${error.message}`);
        }
    }
        ...
        <main className="container mx-auto mt-28 flex min-h-screen px-5">
            <div className="mx-auto w-full md:w-2/3">
                ...
                <form onSubmit={onSubmit}>
                    {(Object.keys(modelMetadata) as Array<keyof UserMetadata>).map(key => {
